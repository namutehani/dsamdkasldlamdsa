...
from config import FORCE_SUB_CHANNEL,FORCE_SUB_CHANNEL1,FORCE_SUB_CHANNEL2,FORCE_SUB_CHANNEL3,FORCE_SUB_CHANNEL4,FORCE_SUB_CHANNEL5,FORCE_SUB_CHANNEL6,FORCE_SUB_CHANNEL7,FORCE_SUB_CHANNEL8, ADMINS
...
async def is_subscribed(filter, client, update):
    ...
    if not FORCE_SUB_CHANNEL9:
        return True
    try:
        member2 = await client.get_chat_member(chat_id = FORCE_SUB_CHANNEL9, user_id = user_id)
    except UserNotParticipant:
        return False
